...
echo "error please enter valid data ";
	...
	if (isset($_POST['submit']))
		{					
			...
			$sql="INSERT INTO `transfer`(emp_id, FName, LName, reason, datee, reciever)VALUES('$emp_id', '$emp_name', '$emp_lname', '$reason', '$date','$reciever')";
...
<div id="id01" class="modal">
	...
	<table style="background-color:white;" width="97%" height="30px" align="center">
			...
			<tr><td><b>Reciever Organization :</b></td></tr>
			<tr><td>
				<input type="text" name="reciever" placeholder="Reciever Organization" onKeyPress="return isCharKey(event)"  id="reciever"  size="30"> <span class="error"> <?php echo $ltErr;?></span></td>
			</tr>
