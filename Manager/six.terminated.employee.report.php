...
//$query21=mysqli_fetch_array($query11);
//$department=$query21['Dept_name'];
 ...
 ?>
  ...
  <div id="print_content">
    <?php
  $sql = mysql_query("select *  from terminated_employee where datee>=DATE_SUB(NOW(), INTERVAL 6 MONTH);");
...
በዚህ አመት ስራቸውን የለቀቁ ሰራተኞች ስም ዝርዝር<center></th></tr>";
print"<tr style='background-color:#ffffff;color: #000000;'>";
...
print"<tr style='background-color:#ffffff;color: #000000;'>";
print"<th width='80px'> Employee ID</th>";
print"<th width='80px'> Hired Date</th>";
print"<th width='80px'> First Name</th>";
print"<th width='80px'> Middle Name</th>";

print"<th width='80px'> Last Name</th>";
print"<th width='80px'>  Birth Place </th>";
print"<th width='80px'> Birth Date</th>";
print"<th width='80px'> Nation </th>";

print"<th width='80px'> Gender </th>";
print"<th width='80px'> Email </th>";
print"<th width='80px'> Salary </th>";
print"<th width='80px'> Level </th>";
print"<th width='80px'> Position </th>";
print"<th width='80px'> Terminated Date </th>";
...
Print "<td>" . $row['terminated_date'] . "</td>";
