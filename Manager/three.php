...
<div class = "main">
<h3 style="text-align: center;">Three month report list:</h3>
<div style="text-align: left;margin-left: 400px; padding:5px;">
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.terminated.employee.report.php" target="_blank"> በዚህ እሩብ አመት ስራቸውን የለቀቁ ሰራተኞች ስም ዝርዝር</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.app.report.php" target="_blank">በዚህ እሩብ አመት ለክፍት ስራ ቦታዉ ያመለከቱ አመልካቾች</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.approved.leave.report.php " target="_blank">በዚህ እሩብ አመት ፍቃድ የጠየቁ እና ጥያቄያቸው የጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.rejected.leave.report.php " target="_blank">በዚህ እሩብ አመት ፍቃድ የጠየቁ እና ጥያቄያቸው ያልጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.report.dep.php" target="_blank">በዚህ እሩብ አመት ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ የጠየቁ የስራ ክፍሎች</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.report.rejected.php" target="_blank">በዚህ እሩብ አመት ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ ጠይቀው ጥያቄያቸው ያልጸደቀላቸው<br>
	<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.report.approved.php " target="_blank">በዚህ እሩብ አመት ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ ጠይቀው ጥያቄያቸው የጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="three.report.vacancy.php " target="_blank">በዚህ እሩብ አመት የወጡ የስራ ማስታወቂያዎች</a>
</div>
