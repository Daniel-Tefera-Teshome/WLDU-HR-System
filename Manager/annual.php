...
<div class = "main">
<h3 style="text-align: center;">Annual report list:</h3>
<div style="text-align: left;margin-left: 400px; padding:5px;">
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.employee.report.php" target="_blank"> በዚህ አመት የተመዘገቡ ሰራተኞች ስም ዝርዝር</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.terminated.employee.report.php" target="_blank"> በዚህ አመት ስራቸውን የለቀቁ ሰራተኞች ስም ዝርዝር</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.app.report.php" target="_blank">በዚህ አመት  ለክፍት ስራ ቦታዉ ያመለከቱ አመልካቾች</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.approved.leave.report.php " target="_blank">በዚህ አመት  ፍቃድ የጠየቁ እና ጥያቄያቸው የጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.rejected.leave.report.php " target="_blank">በዚህ አመት  ፍቃድ የጠየቁ እና ጥያቄያቸው ያልጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.report.dep.php" target="_blank">በዚህ አመት  ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ የጠየቁ የስራ ክፍሎች</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.report.rejected.php" target="_blank">በዚህ አመት ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ ጠይቀው ጥያቄያቸው ያልጸደቀላቸው<br>
  <img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.report.approved.php " target="_blank">በዚህ አመት ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ ጠይቀው ጥያቄያቸው የጸደቀላቸው</a><br>
<img src="righticon.png" style="width: 15px;height: 15px;">
<a style="text-decoration: none;" href="annual.report.vacancy.php " target="_blank">በዚህ አመት የወጡ የስራ ማስታወቂያዎች</a>
</div>
