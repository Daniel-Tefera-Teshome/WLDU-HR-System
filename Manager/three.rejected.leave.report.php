...
function googleTranslateElementInit() {
  ...
  <div id="print_content">
		<?php
    $s = "select *  from `leave`  where status = 'Rejected' and datee >= DATE_SUB(NOW(), INTERVAL 3 MONTH)";
	$sql = mysql_query($s);
...
print"<th colspan=17> <center>
 ...
 ፍቃድ የጠየቁ እና ጥያቄያቸው ያልጸደቀላቸው ሰራተኞች ዝርዝር<center></th></tr>";
print"<tr style='background-color:#ffffff;color: #000000;'>";
...
print"<th width='80px'> Reason</th>";
print"<th width='80px'> Leave Type </th>";
...
Print "<td>" . $row['leave_type'] . "</td>";

}
Print "</tr>";
Print "<tr>";
print "<td colspan=5>"."<b>Total</b>";
print "<td>"."$count";
print "</tr>";
