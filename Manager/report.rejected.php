...
function googleTranslateElementInit() {
  ...
  <div id="print_content">
		<?php
    $s = "select *  from employee_request where status = 'Rejected' and datee >= DATE_SUB(NOW(), INTERVAL 6 MONTH)";
	$sql = mysql_query($s);
...
ክፍት የስራ ቦታው በሰራተኛ እንዲሞላ ጠይቀው ምያቄያቸው ያልጸደቀላቸው የስራ ክፍሎች ዝርዝር<center></th></tr>";
print"<tr style='background-color:#ffffff;color: #000000;'>";
