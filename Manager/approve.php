...
<div class = "main">
	...
	<p style="text-align: center;font-weight: bolder;"> <i> This are what you have to see to approve or reject different requests in the left side menu!! </i> </p>
	<div style="text-align: left;margin-left: 50px;">
		
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Leave:- </b> You have to approve or reject different leave requests that are sent from different employee. <br/><br/>
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Employee Requests:- </b> You have to approve or reject different employee requests that are sent from different departments.<br><br>
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Transfer Requests:- </b> You have to approve or reject different Transfer requests that are sent from different employees. 
	</div>
