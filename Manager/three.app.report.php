...
//$department=$query21['Dept_name'];
 ...
 ?>
  ...
  <div id="print_content">
		<?php
	$sql = mysql_query("select *  from applicant where Date>=DATE_SUB(NOW(), INTERVAL 3 MONTH);");
...
ለወጣው ማስታዎቂያ ያመለከቱ አመልካቾ ዝርዝር<center></th></tr>";
print"<tr style='background-color:#ffffff;color: #000000;'>";
...
print"<th width='80px'> Sex</th>";
print"<th width='80px'> Email </th>";
print"<th width='80px'> CGPA</th>";
