...
<div class = "main">
	...
	<div style="text-align: left;margin-left: 50px;">
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Report:- </b> You can view reports that you want like annual reports, six month and three month reports.  <br/><br/>
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Feedbacks:- </b> You can view feedbacks that are sent from different applicants. <br/><br/>
		<img src="righticon.png" style="width: 15px;height: 15px;"> <b> Applicant:- </b> You can view different applicants with thier respective documents. 
	</div>
