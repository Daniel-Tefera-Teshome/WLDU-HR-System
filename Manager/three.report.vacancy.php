...
//$department=$query21['Dept_name'];
 ...
 ?>
  ...
  <div id="print_content">
		<?php
	$sql = mysql_query("select *  from vacancy where Date>=DATE_SUB(NOW(), INTERVAL 3 MONTH);");
...
የወጡ የስራ ማስታወቂያዎች ዝርዝር<center></th></tr>";
print"<tr style='background-color:#ffffff;color: #000000;'>";
...
print"<tr style='background-color:#ffffff;color: #000000;'>";
print"<th width='80px'> Number</th>";
print"<th width='80px'> Position name</th>";
print"<th width='80px'> Vacancy Position Name</th>";
print"<th width='80px'> Level</th>";

print"<th width='80px'> Amount</th>";
print"<th width='80px'> Required Skill </th>";
print"<th width='80px'> Evidence</th>";
print"<th width='80px'> Position Behavior </th>";
...
Print "<td>" . $row['Vacancy_position'] . "</td>";
Print "<td>" . $row['Level'] . "</td>";


Print "<td>" . $row['Amount'] . "</td>";
Print "<td>" . $row['Skill'] . "</td>";
Print "<td>" . $row['Evidence'] . "</td>";
Print "<td>" . $row['Position_behavior'] . "</td>";
