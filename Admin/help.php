...
<div class = "main">
	...
	<p style="text-align: center;font-weight: bolder;"> Welcome Admin!</p>
	...
	<div style="text-align: left;margin-left: 50px;">
		<img src="image/righticon.png" style="width: 15px;height: 15px;text-align: center;"> <b> Create account:- </b> You can simply create user account by filling the required forms and by selecting the role . <br/>
		<img src="image/righticon.png" style="width: 15px;height: 15px;"> <b> Activate Account:- </b> You can simply activate users account by selecting the options under the change status tab. <br/>
		<img src="image/righticon.png" style="width: 15px;height: 15px;"> <b>  Deactivate Account:- </b> You can simply deactivate users account by selecting the options under the change status tab. <br/>
