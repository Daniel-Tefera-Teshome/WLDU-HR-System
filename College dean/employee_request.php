...
$fErr=$jErr=$lErr=$sErr=$r1Err=$r2Err=$rErr="";

if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	   if (empty($_POST["from"]))
     {$fErr = "<b><font color='red'>Please Fill This Field</font></b>";}
    if (empty($_POST["jname"]))
     {$jErr = "<b><font color='red'>Please Fill This Field</font></b>";}
	   if (empty($_POST["level"]))
     {$lErr = "<b><font color='red'>Please Fill This Field</font></b>";}
    if (empty($_POST["salary"]))
     {$sErr = "<b><font color='red'>Please Fill This Field</font></b>";}
    if (empty($_POST["radio1"]))
     {$r1Err = "<b><font color='red'>Please Select here</font></b>";}
   if (empty($_POST["radio2"]))
     {$r2Err = "<b><font color='red'>Please Select here</font></b>";}
...
echo "error please enter valid data ";
	...
	if (isset($_POST['submit']))
		{					
			...
			$jobposition=$_POST['radio2'];
			$skill=$_POST['skill'];
			$startdate=$_POST['startdate'];
			$request_by=$_POST['request_by'];


			$sql="INSERT INTO employee_request(datee, fromm, job_name, level,salary,job_type, job_position  ,required_skill,start_date,request_by)
			 values('$date','$from','$jname','$level','$salary','$jobtype','$jobposition','$skill','$startdate','$request_by')";
...
<div id="id01" class="modal">
	...
	<h3>Employee Request Form</h3>
	<table style="background-color:white;" width="97%" height="30px" align="center">

			<tr><td><label for="date"><b>Date</b></label></td></tr>
			<tr><td ><input type="text" name="date" size="30"  readonly value="<?php echo date('Y-m-d')?>"><span class="error"></span></td></td></tr>

			<tr><td><b>From:</b></td></tr>
			<tr><td>
				<input type="text" name="from" id="from" onKeyPress="return isCharKey(event)" Placeholder="Write Your Department Name Here" size="30"> <span class="error"> <?php echo $fErr;?></span></td>
			</tr>

			<tr><td><b>Job Name:</b></td></tr>
			<tr><td>
				<input type="text" onKeyPress="return isCharKey(event)" name="jname" id="jname"  placeholder="Write Job Name Here"size="30"> <span class="error"> <?php echo $jErr;?></span></td>
			</tr>
			...
			<tr><td><b>Job Type:</b></td></tr>
			<tr><td>
				  <label class="container">Permanent
				  <input type="radio" value="Permanent"name="radio1"><span class="error"> <?php echo $r1Err;?></span>
				  <span class="checkmark"></span>
				</label>
				<label class="container">Contrat 
				  <input type="radio" value="Contrat" name="radio1">
				  <span class="checkmark"></span>
				</label>			
				</label>
				<label class="container">Temporary 
				  <input type="radio" value="Temporary" name="radio1">
				  <span class="checkmark"></span>
				</label></td>
			</tr>

			<tr>
				<td><b>Job Position:</b></td></tr>
				<tr>
				<td>
				<label class="container">New assigned
				  <input type="radio" value="new assigned"name="radio2"><span class="error"> <?php echo $r2Err;?></span>
				  <span class="checkmark"></span>
				</label>
				<label class="container">released 
				  <input type="radio" value="released" name="radio2">
				  <span class="checkmark"></span>
				</label>
				</td>
			</tr>
			...
			<tr>
				<td><b>Required Qualification For job  position :</b></td></tr><tr>
				<td>
				<textarea name="skill" id="skill"  placeholder="Required Skill"size="60"> </textarea></td>
			</tr>

			<tr>
				<td><b>Job start date by the employee :</b></td></tr><tr>
				<td>
				<input type="text" name="startdate" size="30" placeholder="Date to start the job by the employee"  id="dateStart"><span class="error"> </span></td>
			</tr>

			<tr>
				<td><b>Request by :</b></td></tr><tr>
				<td>
				<input type="text" name="request_by" id="request_by" onKeyPress="return isCharKey(event)" Placeholder="Request by" size="30"> <span class="error"> <?php echo $rErr;?></span></td>
			</tr>
