...
('Dani', 'danieltefera14@gmail.com', 'gsafdhgesjd', 1),
('Daniel', 'deguale@gmail.com', 'hjdsfku', 1);
...
INSERT INTO `leave_request` (`emp_id`, `emp_name`, `reason`, `leave_type`) VALUES
('FOT(R)1699/', 'daniel tefera', 'Transfer', 'blabla'),
('FOT(R)1699/09', 'biruk debebe', 'seek', 'jhik');
...
INSERT INTO `personal_info` (`id`, `emp_id`, `first_name`, `middle_name`, `last_name`, `birth_place`, `birth_date`, `nation`, `gender`, `email`, `salary`, `level`, `position`) VALUES
(0, 'FOT(R)1245/78', 'Abush', 'Zeleke', 'Bewketu', 'Sholla', '0000-00-00', 'Oromo', 'Male', 'abush@gmail.com', 1000, 'III', 'Cashier'),
(1, 'FOT(R)1622/07', 'Dawit', 'Asrat', 'Derbe', 'Legehida', '1250-10-10', 'Tigray', 'Male', 'dawit23@gmail.com', 50000, 'I', 'Manager'),
(0, 'FOT(R)1622/09', 'New', 'Newa', 'Newi', 'Woldia', '0000-00-00', 'Beshangul', 'Male', 'new@gmail.com', 20000, 'I', 'Coder'),
(2, 'FOT(R)1665/08', 'Biruk', 'Debebe', 'Bogale', 'Borena', '0000-00-00', 'Amhara', 'male', 'birukdebe435@gmail.com', 20000, 'II', 'Instractor'),
(0, 'xczx', 'xzc', 'xzc', 'zc', 'zxc', '0000-00-00', 'zc', 'zc', 'zxczc', 0, 'zxc', 'zc');
...
(8, 77, '2019-05-21', 'AAU', 'manager', 'new assigned', '2', 6000, '3.00', 10, ' Degree', ' Degree Certeficate', 'Permanent', ' Bonus', 'AA', '2019-05-31', 'open');
