...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
  ...
  $(document).on('click', '#insert', function(){
   var elementary = $('#data1').text();
   var high_school = $('#data2').text();
   var university = $('#data3').text();
   var cirteficate = $('#data4').text();
   var education_type = $('#data5').text();
   var emp_id = $('#data6').text();
   	...
   	)
   {
    $.ajax({
     url:"inserte.php",
     method:"POST",
     data:{elementary:elementary, high_school:high_school, university:university, cirteficate:cirteficate, education_type:education_type, emp_id:emp_id},
     success:function(data)
     {
      $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
      $('#user_data').DataTable().destroy();
