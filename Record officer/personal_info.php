...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
  ...
  $(document).on('click', '#insert', function(){
   var emp_id = $('#data1').text();
   var first_name = $('#data2').text();
   var middle_name = $('#data3').text();
   var last_name = $('#data4').text();
   var birth_place = $('#data5').text();
   var birth_date = $('#data6').text();
   var nation = $('#data7').text();
   var gender = $('#data8').text();
   var email = $('#data9').text();
   var salary = $('#data10').text();
   var level = $('#data11').text();
   var position = $('#data12').text();
   	...
   	)
   {
    $.ajax({
     url:"insert.php",
     method:"POST",
     data:{emp_id:emp_id, first_name:first_name, middle_name:middle_name, last_name:last_name, birth_place:birth_place, birth_date:birth_date, nation:nation, gender:gender, email:email, salary:salary, level:level, position:position},
     success:function(data)
     {
      $('#alert_message').html('<div class="alert alert-success">'+data+'</div>');
      $('#user_data').DataTable().destroy();
